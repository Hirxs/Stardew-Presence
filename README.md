...
Real Time - Discord RPC Mod

Welcome to Stardew Presence... A mod that displays your "Stardew Valley" save on Discord in real time, not just limiting itself to statistics, but also showing your character and extra content!, such as an avatar, pet, NPC, stats, cinematics, your current location, weather, the home screen, and more! plus, you can customize all of this to your liking

And all this without requiring dependencies!, This mod also includes features such as the ability to invite players using Discord's "Invite to party" function
...
-   Bandwidth friendly with smart image caching
-   GMCM support and translated into English, Spanish, Portuguese, and Chinese
-   Compatible with custom content (except bg, for now...!)
...
-   Adjust the Scale, cycle through animation Frames, and toggle Flip or Layer (in front / behind)
...
-   Click the Settings button inside the editor (or use GMCM) to customize what info you want to display on Discord
